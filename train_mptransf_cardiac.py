...
# torch.backends.cudnn.benchmark = True # Whether to use nondeterministic algorithms to optimize operating efficiency
...
for epoch in range(args.epochs):
    ...
    model.train()
    # if (epoch + 1 % 20) == 0 and epoch + 1 < 80:
    ...
    if eval_mode == "slice":
        ...
        if dices / (args.classes - 1) > best_dice:
            ...
            save_path = './checkpoints/' + args.modelname + '_w2s8_%s' % timestr + '_' + str(best_dice)
